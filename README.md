...
A GraphQL API for the Vine Graph project, built with Node.js, Apollo Server, and Neo4j. This service provides a graph-based interface to explore biblical data.
